...
import uuid
from hrm.models import *  # noqa: F403
...
class UserProfile(models.Model):
    ...
    branch = models.ForeignKey(Branch, on_delete=models.SET_NULL, blank=True, null=True)  # noqa: F405
    department = models.ForeignKey(Department, on_delete=models.SET_NULL, blank=True, null=True)  # noqa: F405
    designation = models.ForeignKey(Designation, on_delete=models.SET_NULL, blank=True, null=True)  # noqa: F405
    job_type = models.ForeignKey(JobType, on_delete=models.SET_NULL, blank=True, null=True)  # noqa: F405
...
def create_customer_profile(sender, instance, created, **kwargs):  # noqa: F811
    if created:
...
@receiver(post_save, sender=Guser)
def save_customer_profile(sender, instance, **kwargs):  # noqa: F811
    if hasattr(instance, 'userprofile'):
        instance.userprofile.save()
